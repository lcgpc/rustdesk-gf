...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "已連線就緒"),
        ("Established", "已建立"),
        ("connecting_status", "正在連線到 超級巨星 專用伺服器..."),
        ("Enable service", "啟用服務"),
        ("Start service", "啟動服務"),
        ...
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "超級巨星專用版 免安裝模式。若要避開 UAC且常駐，請點選下方安裝按鈕將程式安裝到系統中。"),
        ...
        ("setup_server_tip", "已經連線到 超級巨星 專用伺服器"),
        ...
        ("About RustDesk", "超級巨星專用版 v1.4.1.02"),
